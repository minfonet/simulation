...
export default function TraineeSessionDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  function getLaunchCommand(): string {
    ...
    return `godot --path "simulation/driving-sim" --session-id ${id} --api-url ${apiUrl} --token ${token}`
  }
...
if ([string]::IsNullOrWhiteSpace($ProjectPath)) {
    # Try to find project.godot relative to this script
    $scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
    $projectFile = Get-ChildItem -Recurse -Filter "project.godot" -Path $scriptDir -ErrorAction SilentlyContinue | Select-Object -First 1
    if ($projectFile) {
...
if ($ProjectPath) { Write-Host "  Project:    $ProjectPath" }
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-xs text-zinc-500 mb-2">
                Run this from your <strong>repository root</strong> (where <code>simulation/driving-sim/</code> lives),
                or <code>cd simulation/driving-sim</code> and remove <code>--path "simulation/driving-sim"</code>.
              </p>
