...
## Summary
Set up Vitest testing infrastructure for the Next.js 16 frontend, wrote 26 passing tests across 3 test files, and updated run-and-debug.md documentation.
...
- E2E smoke tests via PowerShell/curl
